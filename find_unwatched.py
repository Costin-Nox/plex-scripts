...
# ## EDIT THESE SETTINGS ##
TAUTULLI_APIKEY = 'cc8c4c8ea4b0488abb619efcff0d2445'  # Your Tautulli API key
TAUTULLI_URL = 'http://192.168.0.12:8181/'  # Your Tautulli URL
    ...
    if del_file.startswith('y'):
        for x in tmp_lst:
            ...
            try:
                ...
                print("Failed to delete file, probably already deleted.. {e}").format(e=e)
    else:
